  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name: "Mohammed Farves",
          from_email: form.email,
          to_email: "farveztech@gmail.com",
    ...
    <div className='xl:mt-12 flex xl:flex-row flex-col-reverse gap-10 overflow-hidden'>
      ...
      >
        ...
        >
          ...
          <button
            type='submit'
            className='bg-primary py-3 px-6 rounded-xl outline-none w-fit text-white font-bold shadow-md shadow-primary'
          >
